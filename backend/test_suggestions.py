...
def suggestions_test(self, prompt_file, resume_file, job_file, example_files=[]):
    ...
    for example in example_files:
        example_path = os.path.join(
            "sample_data", "sample_resume_suggestions", example)
...
class FlaskTest(unittest.TestCase):
    ...
    def test_zero_shot_Cynthia_Lenovo(self):
        suggestions_test(self, "suggestion_zero_shot.txt",
                         "cynthia_dwayne.txt", "lenovo.txt")

    def test_zero_shot_Ava_EpicGames(self):
        suggestions_test(self, "suggestion_zero_shot.txt",
                         "ava_johnson.txt", "epicgames.txt")

    def test_zero_shot_Charles_Fidelity(self):
        suggestions_test(self, "suggestion_zero_shot.txt",
                         "charles_mcturland.txt", "fidelity.txt")

    def test_zero_shot_Cynthia_RedHat(self):
        suggestions_test(self, "suggestion_zero_shot.txt",
                         "cynthia_dwayne.txt", "redhat.txt")

    def test_zero_shot_Charles_Apple(self):
        suggestions_test(self, "suggestion_zero_shot.txt",
                         "charles_mcturland.txt", "apple.txt")

    def test_one_shot_Cynthia_Lenovo(self):
        suggestions_test(self, "suggestion_one_shot.txt",
                         "cynthia_dwayne.txt", "lenovo.txt", one_shot_examples)

    def test_one_shot_Ava_EpicGames(self):
        suggestions_test(self, "suggestion_one_shot.txt",
                         "ava_johnson.txt", "epicgames.txt", one_shot_examples)

    def test_one_shot_Charles_Fidelity(self):
        suggestions_test(self, "suggestion_one_shot.txt",
                         "charles_mcturland.txt", "fidelity.txt", one_shot_examples)

    def test_one_shot_Cynthia_RedHat(self):
        suggestions_test(self, "suggestion_one_shot.txt",
                         "cynthia_dwayne.txt", "redhat.txt", one_shot_examples)

    def test_one_shot_Charles_Apple(self):
        suggestions_test(self, "suggestion_one_shot.txt",
                         "charles_mcturland.txt", "apple.txt", one_shot_examples)

    def test_one_shot_long_Cynthia_Lenovo(self):
        suggestions_test(self, "suggestion_one_shot_long.txt",
                         "cynthia_dwayne.txt", "lenovo.txt", one_shot_examples)
