...
class FlaskTest(unittest.TestCase):
    def test_zero_shot_Charles_Lenovo(self):
        cv_test(self, "cv_zero_shot.txt", "charles_mcturland.txt", "lenovo.txt")
    ...
    def test_zero_shot_Charles_EpicGames(self):
        cv_test(self, "cv_zero_shot.txt", "charles_mcturland.txt", "epicgames.txt")
    ...
    def test_one_shot_Charles_Lenovo(self):
        cv_test(self, "cv_one_shot.txt", "charles_mcturland.txt", "lenovo.txt", one_shot_examples)
    
    def test_one_shot_Cynthia_Fidelity(self):
        cv_test(self, "cv_one_shot.txt", "cynthia_dwayne.txt", "fidelity.txt", one_shot_examples)
    
    def test_one_shot_Ava_RedHat(self):
        cv_test(self, "cv_one_shot.txt", "ava_johnson.txt", "redhat.txt", one_shot_examples)
    
    def test_one_shot_Charles_EpicGames(self):
        cv_test(self, "cv_one_shot.txt", "charles_mcturland.txt", "epicgames.txt", one_shot_examples)
    
    def test_one_shot_Ava_Apple(self):
        cv_test(self, "cv_one_shot.txt", "ava_johnson.txt", "apple.txt", one_shot_examples)
    
    def test_one_shot_long_Charles_Lenovo(self):
        cv_test(self, "cv_one_shot_long.txt", "charles_mcturland.txt", "lenovo.txt", one_shot_examples)
    
    def test_one_shot_long_Cynthia_Fidelity(self):
        cv_test(self, "cv_one_shot_long.txt", "cynthia_dwayne.txt", "fidelity.txt", one_shot_examples)
    
    def test_one_shot_long_Ava_RedHat(self):
        cv_test(self, "cv_one_shot_long.txt", "ava_johnson.txt", "redhat.txt", one_shot_examples)
    
    def test_one_shot_long_Charles_EpicGames(self):
        cv_test(self, "cv_one_shot_long.txt", "charles_mcturland.txt", "epicgames.txt", one_shot_examples)
    
    def test_one_shot_long_Ava_Apple(self):
        cv_test(self, "cv_one_shot_long.txt", "ava_johnson.txt", "apple.txt", one_shot_examples)
    
    def test_few_shot_Charles_Lenovo(self):
        cv_test(self, "cv_few_shot.txt", "charles_mcturland.txt", "lenovo.txt", few_shot_examples)
    
    def test_few_shot_Cynthia_Fidelity(self):
        cv_test(self, "cv_few_shot.txt", "cynthia_dwayne.txt", "fidelity.txt", few_shot_examples)
    
    def test_few_shot_Ava_RedHat(self):
        cv_test(self, "cv_few_shot.txt", "ava_johnson.txt", "redhat.txt", few_shot_examples)
    
    def test_few_shot_Charles_EpicGames(self):
        cv_test(self, "cv_few_shot.txt", "charles_mcturland.txt", "epicgames.txt", few_shot_examples)
    
    def test_few_shot_Ava_Apple(self):
        cv_test(self, "cv_few_shot.txt", "ava_johnson.txt", "apple.txt", few_shot_examples)
